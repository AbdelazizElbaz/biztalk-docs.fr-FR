...
---
# <a name="subscribing-to-and-extracting-messages"></a>S’abonner à et l’extraction des Messages
Orchestration peut contenir du code pour s’abonner et extraire les messages d’un message d’erreur ESB. Par exemple, le code suivant utilise la **GetMessage** et **GetException** pour extraire deux fortement typée de messages et la **System.Exception** objet à partir d’une architecture ESB message d’erreur.  
...
```  
 ...
 Pour extraire les messages sans type, le code suivant utilise la **GetMessages** méthode pour extraire tous les messages et à les parcourir.  
