...
3.  Dans le **propriétés de l’accord** boîte de dialogue, cliquez sur **enregistrer comme modèle**.  
  
4.  Dans le **enregistrer en tant que** boîte de dialogue, accédez à l’emplacement où vous voulez exporter le fichier XML pour fournir un nom pour le fichier XML, puis cliquez sur **enregistrer**.  
  
5.  Dans le **créer un modèle** , cliquez sur **OK**.  
