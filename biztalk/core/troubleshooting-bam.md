...
2.  <span data-ttu-id="dec0f-144">À l'invite de commandes, tapez la commande suivante :</span><span class="sxs-lookup"><span data-stu-id="dec0f-144">Type the following command at the command prompt:</span></span>  
