...
---
# <a name="how-to-script-import-export-and-deployment-of-business-policies"></a>Script d’importation / exportation et déploiement de stratégies d’entreprise
Cette section décrit comment par programmation importation/exportation et déployer des stratégies à l’aide de **RuleSetDeploymentDriver**.  
