...
---
# <a name="windows-workflow-foundation-schema"></a>Schéma Windows Workflow Foundation
Cette section contient le schéma de l'intercepteur Windows Workflow Foundation.  
