...
2.  Dans la console Administration de BizTalk, développez  **[!INCLUDE[prague](../includes/prague-md.md)] Administration**, développez **groupe BizTalk**, développez **Applications**, puis développez l’application dans lequel vous souhaitez créer un emplacement de réception.  
