...
3.  Type **ssoclient – serveur  *\<serveur d’authentification unique\>***, où \< *serveur d’authentification unique\>*  est le nom du serveur Single Sign-On l’utilisateur veut se connecter.  
