...
---
# <a name="single-sign-on-event-10656"></a>Single Sign-On : Événement 10656
...
|ID d'événement|10656|  
|Source de l'événement|ENTSSO|  
|Composant|N\A|  
|Nom symbolique|SSO_INFO_PASSWORD_SYNC_ADAPTERS_STARTING|  
|Texte du message|La synchronisation des mots de passe pour les adaptateurs externes est en cours de démarrage.%r|  
  
## <a name="explanation"></a>Explication  
 Cet événement d'informations indique que la synchronisation des mots de passe pour les adaptateurs externes est en cours de démarrage.  
