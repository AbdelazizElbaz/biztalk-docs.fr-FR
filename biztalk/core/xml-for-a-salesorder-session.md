...
---
# <a name="xml-for-a-salesorder-session"></a>XML pour une session SalesOrder
Les sections suivantes proposent des exemples de code XML pour une session SalesOrder.  
  
## <a name="begindoc-xml-sample"></a>Exemple XML BeginDoc  
...
## <a name="editline-xml-sample"></a>Exemple XML EditLine  
...
## <a name="enddoc-xml-sample"></a>Exemple XML EndDoc  
