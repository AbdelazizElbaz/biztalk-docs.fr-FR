...
---
# <a name="error---no-method-for-scripting-functoid"></a>Erreur : aucune méthode pour le fonctoid script
**Code d’erreur**  
 ...
 **Explication**  
 ...
 Le **méthode de Script** propriété du fonctoid **script** fonctoid n’a pas été défini même si le **le Type de Script** propriété indique qu’un assembly externe contient le script pour cette **script** fonctoid.  
