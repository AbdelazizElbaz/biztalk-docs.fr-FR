...
|------------------------|-------------------------------------------------------------------------------------|--------------------------------------------------------|  
|\<Importer >|Prise en charge par l'Assistant Consommation de service WCF BizTalk et Svcutil.exe|Prise en charge par l'Assistant Consommation de service WCF BizTalk et Svcutil.exe|  
