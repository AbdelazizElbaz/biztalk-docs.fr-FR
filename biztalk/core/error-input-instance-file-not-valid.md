...
---
# <a name="error---input-instance-file-not-valid"></a>Erreur : fichier d’Instance d’entrée non valide
**Explication**  
  
 La valeur spécifiée pour le **nom de fichier d’entrée Instance** propriété du fichier de schéma n’est pas un nom de fichier valide.  
