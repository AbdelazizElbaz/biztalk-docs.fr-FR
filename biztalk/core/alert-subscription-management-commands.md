 ...
 **BM.exe get-subscriptions-View :\<nom de la vue >-alerte :\<nom de l’alerte > [-Server :\<serveur >] [-base de données :\<base de données >]**  
 ...
 **BM.exe ajouter-subscription-View :\<nom de la vue >-alerte :\<nom de l’alerte > - AccountName :\<nom du compte >-Type : [fichier &#124; Email] [-messagerie :\<adresse de messagerie >] [-Server :\<serveur >] [-base de données :\<base de données >]**  
 ...
 **BM.exe remove-subscription-View :\<nom de la vue >-alerte :\<nom de l’alerte > - AccountName :\<nom du compte > [-Server :\<serveur >] [-base de données :\<base de données >]**  
