 ...
 **BM.exe get-config - FileName :\<fichier de sortie\> [-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe get-changes [-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe get-defxml - FileName :\<fichier de sortie\>[-Server :\<server\> ] [-base de données :\<base de données\> ]**  
