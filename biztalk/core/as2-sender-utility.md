...
##  <span data-ttu-id="b8c64-127"><a name="BKMK_Custom"></a>La personnalisation de l’utilitaire AS2 Sender</span><span class="sxs-lookup"><span data-stu-id="b8c64-127"><a name="BKMK_Custom"></a> How to Customize the AS2 Sender Utility</span></span>  
