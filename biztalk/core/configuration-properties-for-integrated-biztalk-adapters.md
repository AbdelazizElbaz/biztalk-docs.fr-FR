...
## <a name="in-this-section"></a>Dans cette section  
 [Types de Variable de propriété de configuration](../core/configuration-property-variable-types.md)  
 ...
 [POP3 Propriétés de Configuration de l’adaptateur](../core/pop3-adapter-configuration-properties.md)  
