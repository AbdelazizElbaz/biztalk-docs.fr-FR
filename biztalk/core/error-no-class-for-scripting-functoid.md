...
---
# <a name="error---no-class-for-scripting-functoid"></a>Erreur : aucune classe pour le fonctoid script
**Code d’erreur**  
 ...
 **Explication**  
 ...
 Le **classe du Script** propriété du fonctoid **script** fonctoid n’a pas été défini même si le **le Type de Script** propriété indique qu’un assembly externe contient le script pour cette **script** fonctoid.  
