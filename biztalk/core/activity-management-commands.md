 ...
 **BM.exe get-activities [-View :\<nom de la vue\> ] [-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe remove-activity-nom :\<nom de l’activité\>[-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe get-activitywindow-activité :\<nom de l’activité\>[-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe set-activitywindow-activité :\<nom de l’activité\> - TimeLength :\<nombre entier\> - TimeUnit : mois &#124; jour &#124; Heure &#124; Minute [-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe get-index-activité :\<nom de l’activité\>[-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe create-index - IndexName :\<nom de l’index\> -activité :\<nom de l’activité\> -point de contrôle :\<point de contrôle 1\>[,\<point de contrôle 2\>...] [-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe delete-index - IndexName :\<nom de l’index\> -activité :\<nom de l’activité\>[-Server :\<server\> ] [-base de données :\<base de données\> ]**  
 ...
 **BM.exe get-archive-activité :\<activité\> [-Server :\<server\>] [-base de données :\<base de données\>]**  
 ...
 **BM.exe set-archive - activité :\<activité\> - ShouldArchive : True [-Server :\<server\>] [-base de données :\<base de données\>]**  
