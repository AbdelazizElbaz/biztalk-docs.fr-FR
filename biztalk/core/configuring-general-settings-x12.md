...
---
# <a name="configuring-general-settings-x12"></a>Configuration des paramètres généraux (X12)
...
2.  Les tableaux suivants répertorient les différentes propriétés et les valeurs pour les propriétés de la **propriétés générales** page.  
    ...
    1.  Dans le **paramètres de l’accord** section, procédez comme suit :  
        ...
        |**Protocole**|Spécifie le protocole pour l'accord. Pour un X12 protocole de codage, sélectionnez **X12** dans la liste déroulante.|  
...
4.  Dans le **général** sous l’onglet dans le **des propriétés supplémentaires** page, procédez comme suit :  
    ...
    2.  Dans le **texte 1**, **texte 2**, et **accord** zones de texte, entrez les informations sur l’accord avec un tiers.  
        ...
        > [!IMPORTANT]
        >  Si vous cliquez sur **OK** ou **appliquer** après fournir toutes les valeurs répertoriées dans cette page, vous obtiendrez une erreur. Cela est dû au fait que les valeurs obligatoires pour créer un accord ne sont pas encore fournies. Il s’agit des ISA5 à ISA8 valeurs sur le **identificateurs** page de chaque onglet d’accord unidirectionnel.  
  
## <a name="next-steps"></a>Étapes suivantes  
 Vous devez à présent configurer les paramètres d'échange ou de documents informatisés pour l'accord. Pour obtenir des instructions, consultez [configuration des paramètres de l’échange (X12)](../core/configuring-interchange-settings-x12.md) ou [configuration des paramètres des documents informatisés (X12)](../core/configuring-transaction-set-settings-x12.md).  
