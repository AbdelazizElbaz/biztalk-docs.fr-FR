...
### <a name="to-add-an-existing-schema"></a>Pour ajouter un schéma existant  
  
1.  Dans **l’Explorateur de solutions**, sélectionnez le projet BizTalk auquel vous souhaitez ajouter un schéma existant.  
