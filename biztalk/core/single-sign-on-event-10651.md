...
---
# <a name="single-sign-on-event-10651"></a>Single Sign-On : Événement 10651
...
|ID d'événement|10651|  
|Source de l'événement|ENTSSO|  
|Composant|N\A|  
|Nom symbolique|SSO_INFO_PASSWORD_SYNC_STARTED|  
|Texte du message|Les services de synchronisation de mot de passe ont été correctement initialisés.%r|  
  
## <a name="explanation"></a>Explication  
 Cette information indique que les services de synchronisation de mot de passe ont été initialisés.  
