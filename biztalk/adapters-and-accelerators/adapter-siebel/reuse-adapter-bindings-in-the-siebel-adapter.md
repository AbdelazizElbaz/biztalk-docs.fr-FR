...
---
# <a name="reuse-adapter-bindings-in-the-siebel-adapter"></a>Réutiliser les liaisons de l’adaptateur dans l’adaptateur Siebel
...
Pour plus d’informations sur la spécification du nom d’utilisateur et mots de passe, consultez [configurer l’authentification dans les informations d’identification pour le Siebel](../../adapters-and-accelerators/adapter-siebel/configure-the-sign-in-credentials-for-the-siebel.md).
