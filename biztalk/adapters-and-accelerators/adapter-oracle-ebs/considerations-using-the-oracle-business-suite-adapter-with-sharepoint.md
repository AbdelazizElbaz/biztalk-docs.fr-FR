...
##  <span data-ttu-id="f1d28-132"><a name="Custom_Web_Part"></a>Problèmes qui impliquent des composants WebPart personnalisés</span><span class="sxs-lookup"><span data-stu-id="f1d28-132"><a name="Custom_Web_Part"></a> Issues Involving Custom Web Parts</span></span>  
...
###  <span data-ttu-id="f1d28-135"><a name="Issue1"></a>Problème 1 : Limite d’affichage d’un enregistrement unique dans Microsoft Office SharePoint Server en fonction de plusieurs valeurs</span><span class="sxs-lookup"><span data-stu-id="f1d28-135"><a name="Issue1"></a> Issue 1: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
