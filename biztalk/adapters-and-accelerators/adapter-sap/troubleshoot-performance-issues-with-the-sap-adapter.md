...
##  <a name="BKMK_SAPSlowdown"></a><span data-ttu-id="7b58f-104">Ralentissement ou blocage dans le débit lors de l’utilisation de l’adaptateur avec BizTalk Server</span><span class="sxs-lookup"><span data-stu-id="7b58f-104">Slowdown or stall in throughput when using the adapter with BizTalk Server</span></span>  
...
##  <a name="BKMK_SAPMemLeak"></a><span data-ttu-id="7b58f-113">Fuite de mémoire possible lors de l’utilisation de valeurs NULL pour les paramètres</span><span class="sxs-lookup"><span data-stu-id="7b58f-113">Possible memory leak when using NULL values for parameters</span></span>  
