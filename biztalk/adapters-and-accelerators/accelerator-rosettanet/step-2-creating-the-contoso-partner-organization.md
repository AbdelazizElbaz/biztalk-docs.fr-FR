...
---
# <a name="step-2-creating-the-contoso-partner-organization"></a>Étape 2 : Création de l’organisation partenaire Contoso
Dans cette étape, vous utilisez la [!INCLUDE[btsCoName](../../includes/btsconame-md.md)]® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] Console de gestion pour créer un nouveau partenaire commercial. Le partenaire commercial pour ce didacticiel est l'organisation Contoso.  
...
2.  Dans la boîte de dialogue Propriétés du nouveau partenaire, sous l'onglet **Général** , procédez comme suit**:**  
    ...
    |**Nom**|Tapez **CONTOSO**.|  
    |**GBI**|Tapez **123456789**.|  
    |**Classification du partenaire**|Sélectionnez **Fabricant** dans la liste déroulante.|  
    |**Certificat de signature**|Sélectionnez **Signature Contoso [Thumbprint]** dans la liste déroulante.|  
    |**Certificat de chiffrement**|Sélectionnez **Chiffrement Contoso [Thumbprint]** dans la liste déroulante.|  
...
## <a name="see-also"></a>Voir aussi  
 [Étape 3 : Création de l’accord de partenariat commercial Fabrikam 0C2](../../adapters-and-accelerators/accelerator-rosettanet/step-3-creating-the-fabrikam-0c2-trading-partner-agreement.md)