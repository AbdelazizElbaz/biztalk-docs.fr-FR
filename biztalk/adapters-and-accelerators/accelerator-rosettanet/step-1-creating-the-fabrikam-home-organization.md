...
---
# <a name="step-1-creating-the-fabrikam-home-organization"></a>Étape 1 : Création de l’organisation d’origine Fabrikam
Dans cette étape, vous utilisez la [!INCLUDE[btsCoName](../../includes/btsconame-md.md)]® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] Console de gestion pour créer l’organisation d’origine Fabrikam.  
...
1.  Dans le  **[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]**  Console de gestion, développez [!INCLUDE[btaBTARNNoVersionui](../../includes/btabtarnnoversionui-md.md)], avec le bouton droit **accueil organisations**, pointez sur **nouveau**, puis cliquez sur **accueil Organisation**.  
  
2.  Dans la boîte de dialogue Propriétés de la nouvelle organisation d'origine, procédez comme suit :  
  
    |Utiliser|Pour effectuer cette opération|  
    |--------------|----------------|  
    |**Nom**|Tapez **FABRIKAM**.|  
    |**GBI**|Tapez **987654321**.|  
    |**Classification de l’organisation d’origine**|Sélectionnez **Acheteur** dans la liste déroulante.|  
