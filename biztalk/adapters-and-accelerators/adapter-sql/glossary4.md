...
---
# <a name="terms-used-by-the-sql-adapter"></a>Termes utilisés par l’adaptateur SQL
Les termes et définitions suivants sont utilisées dans [!INCLUDE[adaptersql](../../includes/adaptersql-md.md)] aide.  
...
**synonyme**  
Un autre nom pour un objet de portée schéma.  
