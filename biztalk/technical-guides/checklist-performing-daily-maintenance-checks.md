...
|Vérifiez les journaux des événements pour les erreurs et avertissements (vérification de l’administration).|[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]erreurs et événements d’avertissement sont enregistrés dans le journal des applications. La source d’événements est «[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]. »|  
