...
> [!NOTE]  
>  Bien que le [l’optimisation de base de données BizTalk Server](http://go.microsoft.com/fwlink/?LinkID=101578) le livre blanc (http://go.microsoft.com/fwlink/?LinkID=101578) a été écrit avec [!INCLUDE[btsbiztalkserver2006r2](../includes/btsbiztalkserver2006r2-md.md)] à l’esprit les mêmes principes s’appliquent à [!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)].  
...
## <a name="manually-adding-files-to-the-messagebox-database-step-by-step"></a>Ajout manuel de fichiers à la base de données MessageBox, étape par étape  
 Cette section de la rubrique décrit les étapes à suivre pour ajouter manuellement des fichiers à la base de données MessageBox. Dans cet exemple, trois groupes de fichiers sont ajoutés et un fichier est ajouté à chaque groupe de fichiers pour distribuer les fichiers de la MessageBox sur plusieurs disques. Dans cet exemple, les étapes sont effectuées sur [!INCLUDE[btsSQLServer2008R2](../includes/btssqlserver2008r2-md.md)].  
  
### <a name="manually-adding-files-to-the-messagebox-database-on-sql-server-2008-r2"></a>Ajout manuel de fichiers à la base de données MessageBox sur SQL Server 2008 R2  
 **Suivez ces étapes pour ajouter manuellement des fichiers à la base de données MessageBox sur SQL Server 2008 R2 :**  
  
1.  Cliquez sur **Démarrer**, pointez sur **programmes**, pointez sur  **[!INCLUDE[btsSQLServer2008R2](../includes/btssqlserver2008r2-md.md)]** , puis cliquez sur **SQL Server Management Studio** pour afficher le **Se connecter au serveur** boîte de dialogue.  
  
     ![SQL Server 2008 R2 &#45; Écran de connexion](../technical-guides/media/sqlserver2008r2-loginscreen.gif "SQLServer2008R2-Loginscreen")  
