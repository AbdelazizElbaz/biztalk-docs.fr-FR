...
---
# <a name="working-with-the-configuration-framework"></a><span data-ttu-id="40323-102">Utilisation de Configuration Framework</span><span class="sxs-lookup"><span data-stu-id="40323-102">Working with the Configuration Framework</span></span>
<span data-ttu-id="40323-103">Configuration Framework permet de modifier de façon rapide et aisée la configuration de Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] à l'installation.</span><span class="sxs-lookup"><span data-stu-id="40323-103">The Configuration Framework enables you to quickly and easily change Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] configuration at setup.</span></span> <span data-ttu-id="40323-104">Combiné à Microsoft Windows Installer (MSI), Configuration Framework lit et indique l'état de votre ordinateur et les tâches de configuration nécessitant une action.</span><span class="sxs-lookup"><span data-stu-id="40323-104">In conjunction with the Microsoft Windows Installer (MSI), the Configuration Framework reads and reports the state of your computer and the configuration tasks requiring action.</span></span>  
  
 <span data-ttu-id="40323-105">Lorsque vous configurez BizTalk Server pour la première fois à l'aide de l'Assistant Configuration, Configuration Framework génère un fichier XML (instantané de la configuration) que vous pouvez modifier (modification des noms d'utilisateur, mots de passe, etc.) et exporter vers d'autres ordinateurs.</span><span class="sxs-lookup"><span data-stu-id="40323-105">When you configure BizTalk Server for the first time using the Configuration Wizard, the Configuration Framework generates an XML file (a configuration snapshot) that you can then modify (that is, change user names, passwords, and so on) and export to other computers.</span></span> <span data-ttu-id="40323-106">L'instantané de votre configuration est enregistré dans la page Résumé de la configuration, qui fait partie de l'Assistant Configuration.</span><span class="sxs-lookup"><span data-stu-id="40323-106">You save your configuration snapshot on the Configuration Summary page, part of the Configuration Wizard.</span></span> <span data-ttu-id="40323-107">Cet instantané permet de répliquer votre configuration dans le cadre d'une installation scriptée.</span><span class="sxs-lookup"><span data-stu-id="40323-107">You can use this snapshot to replicate your configuration as part of a scripted installation.</span></span> <span data-ttu-id="40323-108">Ce fichier se trouve dans \< *chemin d’Installation de BizTalk*> \ConfigMain.xml.</span><span class="sxs-lookup"><span data-stu-id="40323-108">This file is located at \<*BizTalk Installation Path*>\ConfigMain.xml.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="40323-109">Les mots de passe ne sont pas stockés dans le fichier XML.</span><span class="sxs-lookup"><span data-stu-id="40323-109">Passwords are not stored in the XML file.</span></span> <span data-ttu-id="40323-110">Vous devez entrer les mots de passe éventuels avant d’utiliser ce fichier.</span><span class="sxs-lookup"><span data-stu-id="40323-110">You must enter any passwords before you use this file.</span></span>  
  
## <a name="configuration-framework-command-line-parameters"></a><span data-ttu-id="40323-111">Paramètres de ligne de commande de Configuration Framework</span><span class="sxs-lookup"><span data-stu-id="40323-111">Configuration Framework Command Line Parameters</span></span>  
 <span data-ttu-id="40323-112">Le tableau suivant décrit les paramètres que vous pouvez exécuter dans une ligne de commande au sein de Configuration Framework.</span><span class="sxs-lookup"><span data-stu-id="40323-112">The following table describes the parameters you can run on the command line within the Configuration Framework.</span></span>  
  
|<span data-ttu-id="40323-113">Paramètre de ligne de commande</span><span class="sxs-lookup"><span data-stu-id="40323-113">Command Line Parameter</span></span>|<span data-ttu-id="40323-114">Description</span><span class="sxs-lookup"><span data-stu-id="40323-114">Description</span></span>|  
|----------------------------|-----------------|  
|<span data-ttu-id="40323-115">**/U**</span><span class="sxs-lookup"><span data-stu-id="40323-115">**/U**</span></span>|<span data-ttu-id="40323-116">Annule la configuration de toutes les fonctionnalités.</span><span class="sxs-lookup"><span data-stu-id="40323-116">Unconfigures all features.</span></span> <span data-ttu-id="40323-117">**Remarque :** Vous pouvez supprimer les bases de données BizTalk Server après avoir annulé la configuration des fonctionnalités de BizTalk Server.</span><span class="sxs-lookup"><span data-stu-id="40323-117">**Note:**  You can delete BizTalk Server databases after you unconfigure BizTalk Server features.</span></span> <span data-ttu-id="40323-118">Ne supprimez pas les bases de données BizTalk Server avant d'exécuter cette commande.</span><span class="sxs-lookup"><span data-stu-id="40323-118">Do not delete BizTalk Server databases before you run this command.</span></span> <span data-ttu-id="40323-119">**Remarque :** Si vous voulez supprimer les bases de données BizTalk Server après avoir annulé la configuration des fonctionnalités de BizTalk Server, il est recommandé d’utiliser la commande **net stop winmgmt** pour arrêter le service Windows Management Instrumentation (WMI), éventuellement en cours d’exécution.</span><span class="sxs-lookup"><span data-stu-id="40323-119">**Note:**  If you want to delete BizTalk Server databases after you unconfigure BizTalk Server features, we recommend that you use the **net stop winmgmt** command to stop the Windows Management Instrumentation (WMI) service, which may still be running.</span></span>|  
|<span data-ttu-id="40323-120">**/S**</span><span class="sxs-lookup"><span data-stu-id="40323-120">**/S**</span></span>|<span data-ttu-id="40323-121">Configuration silencieuse.</span><span class="sxs-lookup"><span data-stu-id="40323-121">Silent configuration.</span></span><br /><br /> <span data-ttu-id="40323-122">Vous devez également transmettre le chemin d'accès complet au fichier XML de configuration qui contient les fonctionnalités à installer et configurer.</span><span class="sxs-lookup"><span data-stu-id="40323-122">You must also pass the full path to the configuration XML that contains the features to install and configure.</span></span> <span data-ttu-id="40323-123">Si **/s** n’est pas transmis, l’outil est exécuté en mode interface utilisateur (IU).</span><span class="sxs-lookup"><span data-stu-id="40323-123">If **/s** is not passed, the tool runs in User Interface (UI) mode.</span></span>|  
|<span data-ttu-id="40323-124">**/L**</span><span class="sxs-lookup"><span data-stu-id="40323-124">**/L**</span></span>|<span data-ttu-id="40323-125">-   Définit le chemin d’accès complet au fichier journal (facultatif).</span><span class="sxs-lookup"><span data-stu-id="40323-125">-   Sets the full path to the log file (optional).</span></span>|  
|<span data-ttu-id="40323-126">**/H**</span><span class="sxs-lookup"><span data-stu-id="40323-126">**/H**</span></span>|<span data-ttu-id="40323-127">-   Affiche les paramètres de ligne de commande valides.</span><span class="sxs-lookup"><span data-stu-id="40323-127">-   Shows the valid command line parameters.</span></span>|  
  
## <a name="sample-configuration-xml-file"></a><span data-ttu-id="40323-128">Exemple de fichier XML de configuration</span><span class="sxs-lookup"><span data-stu-id="40323-128">Sample Configuration XML File</span></span>  
 <span data-ttu-id="40323-129">Un exemple de fichier XML de configuration est fourni ci-dessous avec toutes les fonctionnalités installées.</span><span class="sxs-lookup"><span data-stu-id="40323-129">The following is a sample configuration XML file with all features installed.</span></span> <span data-ttu-id="40323-130">Pour créer votre propre fichier de configuration, utilisez l’option Configuration personnalisée sur un serveur [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)], confirmez que tous les composants se sont exécutés correctement, puis choisissez **Exporter la configuration** dans la fenêtre Configuration.</span><span class="sxs-lookup"><span data-stu-id="40323-130">To create your own configuration file, use the Custom configuration option on a [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)], confirm all the components complete successfully, and then choose **Export Configuration** in the Configuration window.</span></span> <span data-ttu-id="40323-131">Vous pouvez ensuite utiliser le fichier de configuration exporté pour configurer d’autres serveurs [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)].</span><span class="sxs-lookup"><span data-stu-id="40323-131">You can then use the exported configuration file to configure other [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]s.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="40323-132">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="40323-132">See Also</span></span>  
 [<span data-ttu-id="40323-133">Configuration de BizTalk Server</span><span class="sxs-lookup"><span data-stu-id="40323-133">Configure BizTalk Server</span></span>](../install-and-config-guides/configure-biztalk-server.md)   